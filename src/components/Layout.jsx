    ...
    <>
      ...
      <header className="sticky top-0 z-40 bg-white text-[#1e293b]">
        ...
        <div className="overflow-hidden border-t border-[#d0d8e0] bg-[#f8fafc] py-1.5">
          ...
          >
            <span className="flex shrink-0 items-center gap-1.5 font-medium text-[#2563eb]">
      ...
      <div className="flex">
        ...
        <main className={`flex-1 px-4 py-6 sm:px-6 sm:py-8 lg:px-8 ${isLoggedIn ? 'min-h-[calc(100vh-57px)]' : 'min-h-screen'}`}>
          <Outlet />
        </main>
      </div>
    </div>
